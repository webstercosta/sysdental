...
<% unless options[:singleton] -%>
    ...
    it "routes to #imprimir_lista" do
      expect(get: "/<%= ns_table_name %>/imprimir_lista").to route_to("<%= ns_table_name %>#imprimir_lista")
    end
...
<% end -%>
    ...
    it "routes to #imprimir" do
      expect(get: "/<%= ns_table_name %>/1/imprimir").to route_to("<%= ns_table_name %>#imprimir", id: "1")
    end
